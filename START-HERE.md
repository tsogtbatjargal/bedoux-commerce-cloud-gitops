...
- **P10–P14 optimization track bootstrapped 2026-08-09** (owner request: optimize/improve the
  ...
  **P10.4 is complete:** ADR 0015's permissions boundary, `bedoux-iam-scoped` v4, replacement
  ...
  implemented through PR #53. Its final head `f04462e` passed all four jobs in run `33006117123`
  and merged to `main` as `775dfe1`. T-1202 live proof and same-session teardown remain; no AWS
  session is open.
